...
double Bourse::getLastPrixAction(string nomAct)const{
    vector<string>p=this->getActionDisponibleAujourdhui();
    if(appartientAction(nomAct,p))
        return this->getPrixAujourdhui(nomAct,p);
